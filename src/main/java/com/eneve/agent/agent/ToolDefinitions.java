...
public final class ToolDefinitions {
    ...
    public static List<ToolUnion> xrayTools() {
        return List.of(
                ToolUnion.ofTool(xraySearchTests()),
                ToolUnion.ofTool(xraySearchExecutions()),
                ToolUnion.ofTool(xrayGetTestExecution()),
                ToolUnion.ofTool(xrayGetTestCoverage()),
                ToolUnion.ofTool(xrayCreateTestExecution()),
                ToolUnion.ofTool(xrayUpdateTestRunStatus())
        );
    }

    private static Tool xraySearchTests() {
        return Tool.builder()
    ...
    private static Tool xraySearchExecutions() {
        return Tool.builder()
    ...
    private static Tool xrayGetTestExecution() {
        return Tool.builder()
    ...
    private static Tool xrayGetTestCoverage() {
        return Tool.builder()
    ...
    private static Tool xrayCreateTestExecution() {
        return Tool.builder()
    ...
    private static Tool xrayUpdateTestRunStatus() {
        return Tool.builder()
