...
public class LinterConfig {
    ...
    @ConfigProperty(name = "linter.phpstan.enabled", defaultValue = "true")
    boolean phpstanEnabled;
    ...
    public boolean isPhpstanEnabled() { return phpstanEnabled; }
