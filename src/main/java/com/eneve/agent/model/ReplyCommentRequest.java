...
public record ReplyCommentRequest(
        ...
        @Schema(required = true, description = "Bitbucket workspace slug",
                example = "csarenergy")
        String workspace,

        @Schema(required = true, description = "Bitbucket repository slug",
                example = "my-repo")
        String repoSlug,

        @Schema(required = true, description = "Bitbucket PR number",
                example = "42")
        String prId,

        @Schema(required = true, description = "Bitbucket comment ID of the agent's original comment that was replied to")
